...
DATABASES = {
    'default': {
        ...
        'NAME': 'appointments.sqlite3',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(BASE_DIR, 'appointments/static')
...
ROOT_URLCONF = 'appointments_site.urls'
